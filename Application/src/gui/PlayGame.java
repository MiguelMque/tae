...
//constructor e inicializador de variables
    ...
    private void setCards() {//guarda las cartas en cada boton
        ...
        btnC1.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + 1 + ".png")));
        btnC2.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + 2 + ".png")));
        btnC3.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + 3 + ".png")));
        btnC4.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + 4 + ".png")));
        btnC5.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + 5 + ".png")));
        btnC6.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + 6 + ".png")));
        btnC7.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + 7 + ".png")));
        btnC8.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + 8 + ".png")));
        btnC9.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + 9 + ".png")));
        btnC10.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + 10 + ".png")));
        btnC11.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + 11 + ".png")));
        btnC12.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + 12 + ".png")));
        btnC13.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + 13 + ".png")));
        btnC14.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + 14 + ".png")));
    }
...
//codificacion de la imagen oculta
    ...
    private void initComponents() {
        ...
        btnNextLvl = new javax.swing.JButton();
        ...
        btnNextLvl.setText("Siguiente nivel");
        btnNextLvl.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnNextLvlActionPerformed(evt);
            }
        });

        jButton2.setBackground(new java.awt.Color(255, 255, 255));
        jButton2.setText("Volver al menú del juego");
        ...
        jButton3.setText("Seleccionar nivel");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnReiniciar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 163, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        ...
        setSize(new java.awt.Dimension(587, 584));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void btnReiniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReiniciarActionPerformed
        System.out.println("Girar todas las cartas, sin revelar contenido");
    ...
    private void btnC13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnC13ActionPerformed
        btnEnabled(btnC13);
          System.out.println("Carta número once girada- Nivel 1");
    ...
    private void btnC14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnC14ActionPerformed
        btnEnabled(btnC14);
          System.out.println("Carta número nueve girada- Nivel 1");
    ...
    private void btnC9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnC9ActionPerformed
        btnEnabled(btnC9);
          System.out.println("Carta número diez girada- Nivel 1");
    ...
    private void btnC10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnC10ActionPerformed
        btnEnabled(btnC10);
          System.out.println("Carta número ochco girada- Nivel 1");
    ...
    private void btnC11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnC11ActionPerformed
        btnEnabled(btnC11);
          System.out.println("Carta número siete girada- Nivel 1");
    ...
    private void btnC12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnC12ActionPerformed
        btnEnabled(btnC12);
          System.out.println("Carta número seis girada- Nivel 1");
    ...
    private void btnC5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnC5ActionPerformed
        btnEnabled(btnC5);
          System.out.println("Carta número catorce girada- Nivel 1");
    ...
    private void btnC6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnC6ActionPerformed
        btnEnabled(btnC6);
          System.out.println("Carta número doce girada- Nivel 1");
    ...
    private void btnC7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnC7ActionPerformed
        btnEnabled(btnC7);
          System.out.println("Carta número trece girada- Nivel 1");
    ...
    private void btnC8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnC8ActionPerformed
        btnEnabled(btnC8);
          System.out.println("Carta número cuatro girada- Nivel 1");
    ...
    private void btnC4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnC4ActionPerformed
        btnEnabled(btnC4);
          System.out.println("Carta número dos girada- Nivel 1");
    ...
    private void btnC3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnC3ActionPerformed
        btnEnabled(btnC3);
          System.out.println("Carta número uno girada- Nivel 1");
    ...
    private void btnC2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnC2ActionPerformed
        btnEnabled(btnC2);
          System.out.println("Carta número tres girada- Nivel 1");
    ...
    private void btnC1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnC1ActionPerformed
        btnEnabled(btnC1);//muestra la carta oculta
          System.out.println("Carta número cinco girada- Nivel 1");
    ...
    private void btnNextLvlActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextLvlActionPerformed
         this.setVisible(false);
        new PlayGame2().setVisible(true);
        System.out.println("Pasar al siguiente nivel");
       
    }//GEN-LAST:event_btnNextLvlActionPerformed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
            new PlayGame().setVisible(true);//muestra la interfaz con la que se esta trabajando
            System.out.println("Interfaz actual");
            }
        });
    }
    ...
    private javax.swing.JButton btnNextLvl;
